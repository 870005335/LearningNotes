...
![image-20220725170223509](JVM与Java体系结构.assets/image-20220725170223509.png)
...
![image-20220725170438409](JVM与Java体系结构.assets/image-20220725170438409.png)

C语言需要自己来分配内存和回收内存，Java全部交给JVM进行分配和回收。

## 2-推荐书籍

![image-20220725170458699](JVM与Java体系结构.assets/image-20220725170458699.png)
...
![image-20220725170524326](JVM与Java体系结构.assets/image-20220725170524326.png)
...
![image-20230302171335276](JVM与Java体系结构.assets/image-20230302171335276.png)
...
![image-20220725171146997](JVM与Java体系结构.assets/image-20220725171146997.png)

Java的体系结构

![image-20220725171228580](JVM与Java体系结构.assets/image-20220725171228580.png)
...
![image-20220725171305967](JVM与Java体系结构.assets/image-20220725171305967.png)

执行引擎包含三部分：解释器，及时编译器，垃圾回收器

## 7-Java代码执行流程

![image-20220725171421783](JVM与Java体系结构.assets/image-20220725171421783.png)
